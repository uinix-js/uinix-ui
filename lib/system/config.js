...
/**
 * @typedef {Object.<string, string[]>} ElementShorthandPropsMapping A mapping of CSS property to an array of prop names.  Values assigned to these props will be applied as styles to the corresponding CSS property.  Props specified earlier in the array takes precedence.
 *
 * @typedef Config Additional configuration for the system.
 * @property {ElementShorthandPropsMapping} elementShorthandPropsMapping
