 ...
 * @property {import('./options.js').Options} options Additional `Options` to configure the system (`Element` component, `styles`).
 */
...
const createSystem = (system = {}) => {
  ...
  const options = createOptions(system.options);
