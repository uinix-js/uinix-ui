 ...
 *
 * @param {import('../system/config.js').ElementShorthandPropsMapping} shorthandPropsMapping
 * @returns {(props: Props) => ResolvedShorthandPropsData}
 */
