 ...
 *
 * @typedef {import('csstype').Properties<StyleValue>} CssProperties
 *    CSS properties assigned to appropriate StyleValues.
 *
 * @typedef {{
 *   [P in keyof CssProperties]: CssProperties[P] | CssProperties[P][];
 * }} StyleObject
