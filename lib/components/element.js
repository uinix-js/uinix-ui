import {useCss, useSystem, useVariant} from '../system/api.js';
...
const Element = (props) => {
  ...
  const {elementShorthandPropsMapping, elementStyles, h} = system.config;
  ...
  return h(as, {...nonShorthandProps, className: mergedClassNames});
};
